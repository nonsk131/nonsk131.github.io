...
### **The Galaxy Progenitors of Stellar Streams around Milky Way-mass Galaxies in the FIRE cosmological simulations (submitted to *ApJ*)**(to be updated when the preprint is on arXiv)
...
![my picture!]({{ site.url }}/assets/stream_local_vel_dispersion-copy.pdf)
